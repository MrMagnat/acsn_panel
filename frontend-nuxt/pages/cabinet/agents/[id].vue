<template>
  <div class="p-8 max-w-4xl mx-auto">
      ...
      <div class="flex items-start justify-between mb-6">
        <div>
          <div class="flex items-center gap-3 mb-1">
            <NuxtLink to="/cabinet/office" class="text-gray-400 hover:text-gray-600 text-sm">← Офис</NuxtLink>
          </div>
    ...
    <EditAgentModal
      ...
      @deleted="navigateTo('/cabinet/office')"
    />
...
function handleAddToolClick() {
  if (atToolLimit.value) { showUpgradeModal.value = true; return }
