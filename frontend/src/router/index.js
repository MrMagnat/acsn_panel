...
const routes = [
  ...
  // Личный кабинет
  {
    ...
    children: [
      ...
      { path: 'skills', name: 'SkillsCatalog', component: () => import('@/pages/cabinet/SkillsCatalogPage.vue') },
  ...
  // Админ панель
  {
    ...
    children: [
      ...
      { path: 'skills', name: 'AdminSkills', component: () => import('@/pages/admin/AdminSkillsPage.vue') },
