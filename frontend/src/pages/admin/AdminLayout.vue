  ...
  <div class="min-h-screen flex bg-surface">
    <aside class="w-56 bg-white border-r border-gray-100 flex flex-col shrink-0">
      <div class="px-6 py-5 border-b border-gray-100">
        <span class="text-xl font-bold text-purple-600">ASCN</span>
      ...
      <nav class="flex-1 px-3 py-4 space-y-1">
        ...
        <RouterLink to="/admin/agents" class="nav-link" active-class="nav-link--active">
          <span>🤖</span> Агенты
        </RouterLink>
        <RouterLink to="/admin/tools" class="nav-link" active-class="nav-link--active">
          <span>🔧</span> Инструменты
        </RouterLink>
        <RouterLink to="/admin/skills" class="nav-link" active-class="nav-link--active">
          <span>✨</span> Скиллы
        </RouterLink>
        ...
        <RouterLink to="/admin/partner" class="nav-link" active-class="nav-link--active">
          <span>🤝</span> Партнёры
        </RouterLink>
